...
const QString BITCOIN_IPC_PREFIX("ddcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ddcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ddcoin: click-to-pay handler");
    else
...
{
    // clicking on ddcoin: URLs creates FileOpen events on the Mac:
