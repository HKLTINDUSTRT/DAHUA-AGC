...
// Copyright (c) 2013 The ddcoin developers
...
uint256 hashGenesisBlock("0x00000a1b192635070878a9317ed499a486289850463cf3f62ce4ceb3e92f79f8");
static const unsigned int timeGenesisBlock = 1473346424;
...
const string strMessageMagic = "ddcoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we ddcoin from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xdaedc514fd144ef271be5055974ab1542479ae9e9b30e5841b962902c79c0f8f"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ddcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ddcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ddcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ddcoin-miner");
    ...
    try { loop {
        ...
        printf("Running ddcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
